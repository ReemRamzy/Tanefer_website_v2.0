<template>
  <v-container>
    ...
    <gb-social-button
        ...
        size="small"
        theme="light"
        iconPath="@/assets/socialIcons"
    >
        Do something with Facebook
    </gb-social-button> -->

    <div class="follow-links">
      <a href="https://www.facebook.com/TaNefer.Tours" target="_blank" class="w-inline-block"><img src="~/assets/images/faceb00k-icon.png" loading="lazy" alt=""></a>
...
export default {
  data () {
    return {
      ...
      networks: [
        { network: 'baidu', name: 'Baidu', icon: 'fa fa-paw', color: '#2529d8' },
