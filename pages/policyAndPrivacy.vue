...
<template>
  <v-container>
    <v-card class="pa-5">
      ...
      <p>Updated at 2025-03-18</p>

      <p>
        Tanefer tours (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy
      ...
      <p>
        ...
        application,
        Tanefer tours. By accessing or using our Service, you signify that you have read, understood, and agree to
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Tanefer Tours, 29 Refaa St. Dokki, Giza
            that is responsible for your information under this Privacy Policy.
          </li>
          <li>
            Country: where
            Tanefer tours or the owners/founders of
            Tanefer tours are based, in this case is Egypt
          </li>
          <li>
            Customer: refers to the company, organization or person that signs up to use the
            Tanefer tours Service to manage the relationships with your consumers or service users.
          </li>
          <li>
            Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to
            visit
            Tanefer tours and use the services.
          </li>
          <li>
          ...
          <li>
            ...
            Tanefer tours or are under contract to perform a service on behalf of one of the parties.
          </li>
          <li>
          ...
          <li>
            ...
            Tanefer tours as described in the relative terms (if available) and on this platform.
          </li>
          <li>
          ...
          <li>
            Website:
            Tanefer tours's site, which can be accessed via this URL: tanefer.com
          </li>
          <li>
            You: a person or entity that is registered with
            Tanefer tours to use the Services.
          </li>
        </ul>
      </p>
      ...
      <ul>
        <li>Name / Username</li><li>Phone Numbers</li><li>Email Addresses</li>
      </ul>
      ...
      <h1>When does Tanefer tours use end user information from third parties?</h1>
      <p>Tanefer tours will collect End User Data necessary to provide the Tanefer tours services to our customers.</p>
      ...
      <h1>When does Tanefer tours use customer information from third parties?</h1>
      <p>We receive some information from the third parties when you contact us. For example, when you submit your email address to us to show interest in becoming a Tanefer tours customer, we receive information from a third party that provides automated fraud detection services to Tanefer tours. We also occasionally collect information that is made publicly available on social media websites. You can control how much of your information social media websites make public by visiting these websites and changing your privacy settings.</p>
      ...
      <p>Tanefer tours will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.</p>
      ...
      <p>The rights you have to request updates or corrections to the information Tanefer tours collects depend on your relationship with Tanefer tours. Personnel may update or correct their information as detailed in our internal company employment policies.</p>
      ...
      <h1>Personnel</h1>
      <p>If you are a Tanefer tours worker or applicant, we collect information you voluntarily provide to us. We use the information collected for Human Resources purposes in order to administer benefits to workers and screen applicants.</p>
      ...
      <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of Tanefer tours or any of its Corporate Affiliates (as defined herein), or that portion of Tanefer tours or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.</p>

      <h1>Affiliates</h1>
      <p>
        We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, "
        Corporate Affiliate" means any person or entity which directly or indirectly controls, is controlled by or is under
        common control with Tanefer tours, whether by ownership or otherwise. Any information relating to you
      ...
      <h1>Governing Law</h1>
      <p>
        This Privacy Policy is governed by the laws of Egypt  without regard to its conflict of laws provision.
      ...
      <p>
        The laws of Egypt , excluding its conflicts of law rules, shall govern this Agreement and your use of
        the website. Your use of the website may also be subject to other local, state, national, or international
        laws.
      </p>
      <p>
        By using
        Tanefer tours or contacting us directly, you signify your acceptance of this Privacy Policy. If you do
      ...
      <p>
        ...
        or controlled by
        Tanefer tours. We are not responsible for the content, accuracy or opinions expressed in such websites,
      ...
      <h1>Cookies</h1>
      <p>
        Tanefer tours uses "Cookies" to identify the areas of our website that you have visited. A Cookie is
      ...
      <p>
        Wherever you're located you may also set your browser to block cookies and similar technologies, but this action
      ...
      <h1>Kids' Privacy</h1>
      <p>
        We do not address anyone under the age of 13. We do not knowingly collect personally identifiable information
      ...
      <p>
        ...
        Tanefer tours shall not be responsible for any Third-Party Services, including their accuracy,
        completeness, timeliness, validity, copyright compliance, legality, decency, quality or any other aspect thereof.
        Tanefer tours does not assume and shall not have any liability or responsibility to you or any other
      ...
      <p>
        Facebook pixel is an analytics tool that allows you to measure the effectiveness of your advertising by
      ...
      <ul>
        <li> Via Email: info@tanefer.com</li>
        <li>Via Phone Number: +20233384000</li>
        <li>Via this Link: https://tanefer.com</li>
      </ul>
    </v-card>
  </v-container>
</template>
...
export default {
  head () {
    return {
      title: 'Privacy Policy - Our Travel Services'
    }
  }
}
</script>
